            ...
            <aside className="w-64 admin-sidebar" aria-label="Sidebar">
                ...
                <div className="overflow-y-auto py-4 px-3 rounded dark:bg-gray-800">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link to="/business/product" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <li>
                            <Link to="/business/store" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                {props.BusinessStore
                                    ? <span className="ml-3 font-bold text-gray-600 dark:text-white">Cửa hàng</span>
                                    : <span className="flex-1 ml-3 whitespace-nowrap">Cửa hàng</span>
                                }
                            </Link>
                        </li>
                        <li>
                            ...
                            <svg className="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" /><path fillRule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clipRule="evenodd" /></svg>                                {props.BusinessTransaction
